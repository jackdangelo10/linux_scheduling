...
#define __NR_cosc_kprint 449
__SYSCALL(__NR_cosc_kprint, sys_cosc_kprint)

#define __NR_cosc_addint 450
__SYSCALL(__NR_cosc_addint, sys_cosc_addint)

#define __NR_sched_set_time_boost 451
__SYSCALL(__NR_sched_set_time_boost, sys_sched_set_time_boost)
